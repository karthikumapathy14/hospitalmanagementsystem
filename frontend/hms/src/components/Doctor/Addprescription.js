...
const Addprescription = () => {
 ...
 console.log('prescription',appid)
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://localhost:7058/api/Doctor/postprescription', payload)
      .then(res => {
  ...
  return (
    <div className='row card'>
      <div className='d-flex align-items-center justify-content-center ' style={{minHeight:'100vh',maxWidth:'100%'}}>
