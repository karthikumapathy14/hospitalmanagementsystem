...
const Login = () => {
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center justify-content-center"
      style={{ background: 'linear-gradient(135deg, #f8f9fa 0%, #e9f7fe 100%)' }}>
              ...
              <div className="row g-0">
                ...
                <div className="col-md-6 d-none d-md-flex align-items-center justify-content-center p-5 text-white"
                  ...
                  <div className="text-center">
                    ...
                    <h2 className="fw-bold mb-3">Medcare Health</h2>
                ...
                <div className="col-md-6 bg-white p-5">
                  ...
                  <form onSubmit={handleFormSubmit}>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-4">
                      ...
                      <a href="/forgotpassword" className="small text-decoration-none">
                        Forgot password?
                      </a>
                    </div>
