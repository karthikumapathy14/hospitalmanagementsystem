...
useEffect(() => {
  ...
  axios
    .get(
      `https://localhost:7058/api/Nurse/getprescriptionbyprescription/${prescriptionId}`,
      {
    ...
    .then((res) => {
      if (res.data && res.data.prescriptionDays) {
        const { appointmentId, prescribedby, prescriptionDays } = res.data;

        const formatted = prescriptionDays.map((day) => ({
          ...day,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "https://localhost:7058/api/Nurse/updateprescription",
        payload,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
              ...
              <form onSubmit={handleSubmit}>
                <div className="row mb-4">
                  <div className="col-md-6 mb-3">
                    ...
                    <input className="form-control bg-light" value={appointmentId} readOnly />
                  </div>
                  <div className="col-md-6 mb-3">
                ...
                <div className="d-flex justify-content-between my-3">
                  ...
                  <button type="submit" className="btn btn-primary">
                    <i className="bi bi-save me-2"></i>Update Prescription
                  </button>
                </div>
              </form>
            </div>
