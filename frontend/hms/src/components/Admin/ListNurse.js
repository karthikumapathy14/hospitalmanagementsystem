                            ...
                            <div className="col-12">
                                <div className="card border-0 p-5 text-center" style={{ 
                                    ...
                                    <div className="bg-light-warning rounded-circle p-3 d-inline-block mb-3">
                                        <i className="bi bi-heart-pulse text-warning" style={{ fontSize: '1.75rem' }}></i>
                                    </div>
                                    <h5 className="text-dark mb-2">No nurses found</h5>
                                    <p className="text-muted">Currently there are no nurses in the system</p>
                                </div>
                            </div>
                        )}
                    </div>
