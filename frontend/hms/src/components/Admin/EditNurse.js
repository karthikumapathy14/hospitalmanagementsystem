...
const EditNurse = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://localhost:7058/api/Admin/getbyid-nurse/${id}`, {
  ...
  const onsubmit = (e) => {
    e.preventDefault();
    axios
      .put(`https://localhost:7058/api/Admin/edit-Nurse/${id}`, nurse, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
