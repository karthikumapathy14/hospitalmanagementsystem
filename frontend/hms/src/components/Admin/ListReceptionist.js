...
const ListReceptionist = () => {
    ...
    useEffect(() => {
        axios.get("https://localhost:7058/api/Admin/get-receptionist")
                                                ...
                                                {item.doctor && (
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <span className="text-muted">
                                                            Doctor: <span className="text-dark">{item.doctor.userName}</span>
                                                        </span>
                                                    </div>
                                                )}
                                            </div>
                            ...
                            <div className="col-12">
                                <div className="card border-0 p-5 text-center" style={{ 
                                    ...
                                    <div className="bg-light-warning rounded-circle p-3 d-inline-block mb-3">
                                        <i className="bi bi-people text-warning" style={{ fontSize: '1.75rem' }}></i>
                                    </div>
                                    <h5 className="text-dark mb-2">No receptionists found</h5>
                                    <p className="text-muted">Currently there are no receptionists in the system</p>
                                </div>
                            </div>
                        )}
                    </div>
